...
RULES = [
    ...
    # Firecrawl adds MCP tools over time. The provider prefix is specific enough
    # to inventory the full surface without hard-coding a stale tool allow-list.
    rule("firecrawl", "runtime", "firecrawl-mcp-tool", r"\bfirecrawl_[a-z][a-z0-9_]*\b"),
